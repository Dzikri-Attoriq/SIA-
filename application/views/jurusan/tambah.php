        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('jurusan/tambah'); ?>">Tambah</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
               ...
               <form action="<?= base_url('jurusan/tambah'); ?>" method="POST">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-1">
	                    <input type="text" class="form-control" id="kd_jurusan" placeholder="" name="kd_jurusan" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="jurusan" class="col-sm-1">Jurusan</label>
                    <div class="col-sm-3">
	                    <input type="text" class="form-control" id="jurusan" placeholder="" name="jurusan" required>
                    </div>
                  </div>
                <!-- /.card-body -->
